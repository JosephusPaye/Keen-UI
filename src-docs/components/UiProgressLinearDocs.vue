<template>
    <section class="section section-ui-progress-linear">
        <h2 class="section-heading">
            UiProgressLinear <a href="https://github.com/JosephusPaye/Keen-UI/blob/0.8.9/src/UiProgressLinear.vue" target="_blank" rel="noopener" class="view-source-link">View Source</a>
        </h2>
        ...
        <h3>
            Examples <a href="https://github.com/JosephusPaye/Keen-UI/blob/0.8.9/src-docs/components/UiProgressLinearDocs.vue" target="_blank" rel="noopener" class="view-source-link">View Source</a>
        </h3>
        ...
        <div class="demo">
            ...
            <div class="group">
                <ui-progress-linear :show="loading" color="primary"></ui-progress-linear>

                <ui-progress-linear :show="loading" color="accent"></ui-progress-linear>

                <ui-progress-linear :show="loading" color="black"></ui-progress-linear>

                <div class="color-wrapper">
                    <ui-progress-linear :show="loading" color="white"></ui-progress-linear>
                </div>
            </div>
