<template>
    <section class="section section-ui-snackbar">
        ...
        <h3>
            Examples <a href="https://github.com/JosephusPaye/Keen-UI/blob/gh-pages/src-docs/components/UiSnackbarDocs.vue" target="_blank" class="view-source-link">View Source</a>
        </h3>
