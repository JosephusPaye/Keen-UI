<template>
    <section class="section section-ui-rating">
        <h2 class="section-heading">
            UiRating &amp; UiRatingPreview <a href="https://github.com/JosephusPaye/Keen-UI/blob/0.8.9/src/UiRating.vue" target="_blank" rel="noopener" class="view-source-link">View Source</a>
        </h2>
        ...
        <h3>
            Examples <a href="https://github.com/JosephusPaye/Keen-UI/blob/0.8.9/src-docs/components/UiRatingDocs.vue" target="_blank" rel="noopener" class="view-source-link">View Source</a>
        </h3>
