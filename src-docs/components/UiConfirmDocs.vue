<template>
    <section class="section section-ui-confirm">
        <h2 class="section-heading">
            UiConfirm <a href="https://github.com/JosephusPaye/Keen-UI/blob/0.8.9/src/UiConfirm.vue" target="_blank" rel="noopener" class="view-source-link">View Source</a>
        </h2>
        ...
        <h3>
            Examples <a href="https://github.com/JosephusPaye/Keen-UI/blob/0.8.9/src-docs/components/UiConfirmDocs.vue" target="_blank" rel="noopener" class="view-source-link">View Source</a>
        </h3>
