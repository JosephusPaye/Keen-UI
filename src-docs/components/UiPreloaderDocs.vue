<template>
    <section class="section section-ui-preloader">
        <h2 class="section-heading">
            UiPreloader <a href="https://github.com/JosephusPaye/Keen-UI/blob/0.8.9/src/UiPreloader.vue" target="_blank" rel="noopener" class="view-source-link">View Source</a>
        </h2>
        ...
        <h3>
            Examples <a href="https://github.com/JosephusPaye/Keen-UI/blob/0.8.9/src-docs/components/UiPreloaderDocs.vue" target="_blank" rel="noopener" class="view-source-link">View Source</a>
        </h3>
