<template>
  <div class="ui-datepicker" :class="classes">
    <input class="ui-datepicker__hidden-input" type="hidden" :name="name" :value="submittedValue" />
    ...
    <div class="ui-datepicker__content">
      ...
      >
        <div v-if="label || $slots.default" class="ui-datepicker__label-text" :class="labelClasses">
          <slot>{{ label }}</slot>
        </div>
