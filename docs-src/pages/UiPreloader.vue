<template>
    <section class="page page-ui-preloader">
        ...
        <h3 class="page__section-title">
            Examples <a href="https://github.com/JosephusPaye/Keen-UI/blob/gh-pages/docs-src/pages/UiPreloader.vue" target="_blank" rel="noopener">View Source</a>
        </h3>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>(required)</td>
                                <td>
                                    <p>Determines whether or not the preloader is shown. Changing this value will show/hide the preloader.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
